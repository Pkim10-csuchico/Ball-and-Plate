...
clientID=coppelia.simxStart('10.0.0.125',19999,true,5000,5);
if client

    clear all; close all; clc
CopSim=remApi('remoteApi'); CopSim.simxFinish(-1); clientID=CopSim.simxStart('10.0.0.125',19999,true,true,5000,5);
if (clientID>-1)  
     disp('Connected');
